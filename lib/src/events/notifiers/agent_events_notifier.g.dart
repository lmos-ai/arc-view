...
String _$agentEventsNotifierHash() =>
    r'd9c3c63ad159d62c03433041112b61e358e72d07';

/// See also [AgentEventsNotifier].
@ProviderFor(AgentEventsNotifier)
final agentEventsNotifierProvider =
    AutoDisposeNotifierProvider<AgentEventsNotifier, List<AgentEvent>>.internal(
...
typedef _$AgentEventsNotifier = AutoDisposeNotifier<List<AgentEvent>>;

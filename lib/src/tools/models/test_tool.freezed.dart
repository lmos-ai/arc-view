...
abstract class $TestToolCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String name, String title, String id, String description, String value});
}
...
class _$TestToolImpl extends _TestTool {
  ...
  @override
  String toString() {
    return 'TestTool(name: $name, title: $title, id: $id, description: $description, value: $value)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, title, id, description, value);
...
abstract class _TestTool extends TestTool {
  factory _TestTool(
      ...
      required final String value}) = _$TestToolImpl;
  _TestTool._() : super._();
